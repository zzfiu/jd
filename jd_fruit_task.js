...
const retainWater = $.isNode() ? (process.env.retainWater ? process.env.retainWater : 10) : $.getdata('retainWater') ? $.getdata('retainWater') : 10; //保留水滴大于多少g,默认100g;
